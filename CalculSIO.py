...
from .CalculSIO_dockwidget import CalculSIODockWidget
import os.path
...
class CalculSIO:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/CalculSIO/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'CalculSIO'),
            callback=self.run,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = CalculSIODockWidget()
